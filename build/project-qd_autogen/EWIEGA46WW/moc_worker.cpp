...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->taskStarted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->taskCompleted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Worker::*)()>(_a, &Worker::connected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)()>(_a, &Worker::disconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(int )>(_a, &Worker::taskStarted, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Worker::*)(int , const QString & )>(_a, &Worker::taskCompleted, 3))
            return;
    }
}
...
// SIGNAL 2
void Worker::taskStarted(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void Worker::taskCompleted(int _t1, const QString & _t2)
{
